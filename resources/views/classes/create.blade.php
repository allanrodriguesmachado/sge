<x-layouts.app>
    <section class="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 dark:border-slate-700 dark:bg-slate-900">
        <div class="mb-6 flex items-center justify-between border-b border-slate-200 pb-3 dark:border-slate-700">
            ...
            <a href="{{ route('class.index') }}" class="flex items-center gap-1 text-sm font-semibold text-slate-600 transition hover:text-indigo-600 dark:text-slate-300 dark:hover:text-indigo-400">
        ...
        <form action="{{ route('class.store') }}" method="post" class="space-y-5">
            ...
            <div>
                <label for="staff_ids" class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-200">Funcionarios</label>
